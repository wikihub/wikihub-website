...
- [Deploy Kubeflow on GCP](https://deploy.kubeflow.cloud)
...
- [MLeap: Productionize Data Science Workflows Using Spark](https://databricks.com/session/mleap-productionize-data-science-workflows-using-spark)
- [Combust](https://github.com/combust)
...
- [The road to 1.0: production ready PyTorch](https://pytorch.org/blog/the-road-to-1_0/)
- [Chainer](https://chainer.org/)
- [MapR Analytics and ML](https://mapr.com/products/analytics-ml/)
- [Omniscience](https://www.omni.sc/)
